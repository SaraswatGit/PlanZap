     ...
     return(
       ...
       <div className="ideabox">
            <div className="ideaboxtop">
              {val.idea_name} &nbsp; <div style={{position:"absolute",marginLeft:"78vw"}}><EditIcon onClick={()=>{settempidea(val.idea_name);settempdesc(val.idea_desc);setnewidea(val.idea_name);setnewdesc(val.idea_desc);settempid(val.ideaid);toggleModal2()}}/>&nbsp; <CloseIcon onClick={()=>{deletenote(val.ideaid)}} /> </div>
          </div>
